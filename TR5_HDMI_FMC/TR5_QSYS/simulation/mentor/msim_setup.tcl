...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_bht_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_bht_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_bht_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_dc_tag_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_dc_tag_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_dc_tag_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_ic_tag_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_ic_tag_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_ic_tag_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/TR5_QSYS_onchip_memory2.hex ./
  file copy -force $QSYS_SIMDIR/submodules/tta_x_blank_mem.hex ./
}
...
ensure_lib                                            ./libraries/sii9678_int/                               
vmap       sii9678_int                                ./libraries/sii9678_int/                               
...
ensure_lib                                            ./libraries/adv7619_int/                               
vmap       adv7619_int                                ./libraries/adv7619_int/                               
ensure_lib                                            ./libraries/EDID_I2C_SDA/                              
vmap       EDID_I2C_SDA                               ./libraries/EDID_I2C_SDA/                              
ensure_lib                                            ./libraries/EDID_I2C_SCL/                              
vmap       EDID_I2C_SCL                               ./libraries/EDID_I2C_SCL/                              
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                           
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_rsp_mux_001.sv"                       -work rsp_mux_001                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                     -work rsp_mux_001                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                     -work rsp_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                             
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                 
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                     -work cmd_mux_001                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                     -work cmd_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_cmd_demux_001.sv"                     -work cmd_demux_001                             
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                                 
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_router_003.sv"                        -work router_003                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_router_002.sv"                        -work router_002                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_router_001.sv"                        -work router_001                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0_router.sv"                            -work router                                    
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu.vo"                                    -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_debug_slave_sysclk.v"                  -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_debug_slave_tck.v"                     -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_debug_slave_wrapper.v"                 -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_mult_cell.v"                           -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0_cpu_test_bench.v"                          -work cpu                                       
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/TR5_QSYS_irq_mapper.sv"                                          -work irq_mapper                                
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_mm_interconnect_0.v"                                    -work mm_interconnect_0                         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_timer.v"                                                -work timer                                     
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_sw.v"                                                   -work sw                                        
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_sii9678_int.v"                                          -work sii9678_int                               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_pll_0.vo"                                               -work pll_0                                     
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_onchip_memory2.v"                                       -work onchip_memory2                            
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_nios2_gen2_0.v"                                         -work nios2_gen2_0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_led.v"                                                  -work led                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_jtag_uart.v"                                            -work jtag_uart                                 
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_button.v"                                               -work button                                    
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_alt_vip_tpg_0.vo"                                       -work alt_vip_tpg_0                             
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/alt_vipitc131_IS2Vid.sv"                                         -work alt_vip_itc_0                             
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/alt_vipitc131_IS2Vid_mode_banks.sv"                              -work alt_vip_itc_0                             
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_adv7619_int.v"                                          -work adv7619_int                               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_EDID_I2C_SDA.v"                                         -work EDID_I2C_SDA                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TR5_QSYS_EDID_I2C_SCL.v"                                         -work EDID_I2C_SCL                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/TR5_QSYS.v"                                                                                                                 
}
